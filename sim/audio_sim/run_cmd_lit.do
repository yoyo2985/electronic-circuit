# cmd_matcher 模板内嵌常量校验 —— 在本目录 sim/audio_sim 执行
...
vlog ../../rtl/clock_enable.v ../../rtl/keypad_scan.v ../../rtl/target_input.v \
     ...
     ../../rtl/cmd_matcher.v ../../rtl/cmd_vote.v ../../rtl/decision_fsm.v \
     ...
     ../../rtl/top_voice_robot.v ../../rtl/top_system.v ../tb_cmd_lit.v
onerror {quit -f}
vsim work.tb_cmd_lit
run -all
quit -f
