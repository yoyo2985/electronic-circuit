...
利用 EG4S20 FPGA、ES8388 实现数字孪生机器人语音交互控制\par}
  ...
  {\zihao{-4}\songti
  本项目已开源，可在 \url{https://github.com/yoyo2985/electronic-circuit}
  查看完整工程源码（RTL/仿真/约束/工具脚本/数字孪生）。\par}
...
此外，本课程设计的全部工程源码（RTL 设计、仿真测试平台、引脚约束、设计文档、工具脚本与 Web 数字孪生）已开源发布至 GitHub 仓库 \url{https://github.com/yoyo2985/electronic-circuit}，评审老师可在此查看本报告的完整配套工程。
